          ...
          <div
            ...
            <div style={{padding: "4px 0px"}}>
              ...
              {showType && (
                <div
                  ...
                  {types.map((type) => (
                    <button key={type.label+i} className='sort-button' onClick={type.onClick}>
            ...
            <div
              ...
              {buttons.map((i, button) => (
                <button key={button.label+i} type='button' className='sort-button' onMouseDown={button.onClick}>
