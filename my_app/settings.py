...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "my_app_language"
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="my_app-media")
...
WAGTAIL_SITE_NAME = "My App Content"
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("My App"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("It is my app."),
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "charles.cfw@gmail.com",
}

# set this to True in production to have URLs generated with https instead of http
USE_HTTPS_IN_ABSOLUTE_URLS = env.bool("USE_HTTPS_IN_ABSOLUTE_URLS", default=False)

ADMINS = [("Charles", "charles.cfw@gmail.com")]
